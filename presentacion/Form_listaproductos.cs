...
namespace presentacion
{
    public partial class Form_listaproductos : Form
    {
        ...
        private void tablaproductosAlmacen_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            if (e.RowIndex < 0)
                return;
        ...
        private void tablaproductosAlmacen_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        }
